...
# pushback_nasa documentation build
...
from pushback_nasa import __version__ as release

# -- Project information -----------------------------------------------------

project = "pushback_nasa"
author = "Kedro"
...
htmlhelp_basename = "pushback_nasadoc"
...
latex_documents = [
    (master_doc, "pushback_nasa.tex", "pushback_nasa Documentation", "Kedro", "manual",)
]
...
man_pages = [(master_doc, "pushback_nasa", "pushback_nasa Documentation", [author], 1,)]
...
texinfo_documents = [
    (
        master_doc,
        "pushback_nasa",
        "pushback_nasa Documentation",
        author,
        "pushback_nasa",
        "Project pushback_nasa codebase.",
        "Data-Science",
    )
]
